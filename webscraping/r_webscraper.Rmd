...
#al_scrape_table %>% write_csv(here("data/files_to_download/alabama_executions.csv"))
```
...
#az_scrape_table %>% write_csv(here("data/files_to_download/arizona_executions.csv"))
```
...
#ar_scrape_table %>% write_csv(here("data/files_to_download/arkansas_executions.csv"))
```
...
#ca_scrape_table %>% write_csv(here("data/files_to_download/california_executions.csv"))
```
