...
write.csv(releases_comp, "releases_per_year.csv")
```
...
write.csv(system_release_comp, "releases_per_year_per_system.csv")
```
...
write.csv(system_count_comp, "reporting_systems_per_year.csv")
```
