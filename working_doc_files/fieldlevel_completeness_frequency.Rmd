...
plot1 <- plot1_wo_title +
  labs(title = "39% (n = 21) of systems contain DCRA name data\n in press releases") +
  theme(plot.title = element_text(hjust = 0.5))

#DCRA Field - Date of Birth 
plot2 <- plot2_wo_title + 
  labs(title = "37% (n = 20) of systems contain DCRA date of birth data\n in press releases") +
  theme(plot.title = element_text(hjust = 0.5))

#DCRA Field - Gender 
plot3 <- plot3_wo_title + 
  labs(title = "37% (n = 20) of systems contain DCRA gender data\n in press releases") +
  theme(plot.title = element_text(hjust = 0.5))

#DCRA Field - Race
plot4 <- plot4_wo_title + 
  labs(title = "57% (n = 31) of systems contain DCRA race data\n in press releases") +
  theme(plot.title = element_text(hjust = 0.5))

#DCRA Field - Ethnicity 
plot5 <- plot5_wo_title + 
  labs(title = "22% (n = 12) of systems contain DCRA ethnicity data\n in press releases") +
  theme(plot.title = element_text(hjust = 0.5))

#DCRA Field - Date of Death 
plot6 <- plot6_wo_title + 
  labs(title = "72% (n = 39) of systems contain DCRA date of death data\n in press releases") +
  theme(plot.title = element_text(hjust = 0.5))

#DCRA Field - Time of Death 
plot7 <- plot7_wo_title +
  labs(title = "13% (n = 7) of systems contain DCRA time of death data\n in press releases") +
  theme(plot.title = element_text(hjust = 0.5))

#DCRA Field - Location of Death
plot8 <- plot8_wo_title + 
  labs(title = "54% (n = 29) of systems contain DCRA location of death data\n in press releases") +
  theme(plot.title = element_text(hjust = 0.5))

#DCRA Field - Facility 
plot9 <- plot9_wo_title + 
  labs(title = "30% (n = 16) of systems contain DCRA facility data\n in press releases") +
  theme(plot.title = element_text(hjust = 0.5))

#DCRA Field - Cause of Death 
plot10 <- plot10_wo_title + 
  labs(title = "33% (n = 18) of systems contain DCRA cause of death data\n in press releases") +
  theme(plot.title = element_text(hjust = 0.5))
