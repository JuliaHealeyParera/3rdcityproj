...
new <- dcra_dataset %>% 
  ...
  rename(Name = c_ind_full_name, 
         ...
         `Cause of Death` = c_ind_cod_avail) %>% 
...
dcra_table_variable_bar %>% 
  ...
  mutate(variable = factor(variable, levels = c("c_ind_full_name", "c_ind_dob_year", "c_ind_gender", "c_ind_race", "c_ind_ethnicity", "c_ind_fachoused", "ind_deathloc", "c_ind_dod_ymd", "ind_tod", "c_ind_cod_avail"))) %>% 
