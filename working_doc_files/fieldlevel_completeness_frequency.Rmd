...
```{r}
path_wo_title <- here("working_doc_files", "dashboard_visualizations", "fieldlevel_completeness_table_wo_title.png")
path_w_title <- here("working_doc_files", "dashboard_visualizations", "fieldlevel_completeness_table_w_title.png") 
...
plot2_wo_title <- joined_agg %>% 
  ...
  scale_size_continuous(guide = "none", limits = c(0, 2.2810334)) + 
  labs(title = "II.",
       fill = "DCRA Date of Birth Data Availability") + 
  theme_void() +
  annotate(
     geom = "text", x = -70, y = 37, 
     label = "DC", size = 3
...
plot3_wo_title <- joined_agg %>% 
  ...
  scale_size_continuous(guide = "none", limits = c(0, 2.2810334)) + 
  labs(title = "III.",
       fill = "DCRA Gender Data Availability") + 
  theme_void() +
  annotate(
     geom = "text", x = -70, y = 37, 
     label = "DC", size = 3
...
plot4_wo_title <- joined_agg %>% 
  ...
  scale_size_continuous(guide = "none", limits = c(0, 2.2810334)) + 
  labs(title = "IV.",
       fill = "DCRA Race Data Availability") + 
  theme_void() +
  annotate(
     geom = "text", x = -70, y = 37, 
     label = "DC", size = 3
...
plot5_wo_title <- joined_agg %>% 
  ...
  scale_size_continuous(guide = "none", limits = c(0, 2.2810334)) + 
  labs(title = "V.",
       fill = "DCRA Ethnicity Data Availability") + 
  theme_void() +
  annotate(
     geom = "text", x = -70, y = 37, 
     label = "DC", size = 3
...
plot6_wo_title <- joined_agg %>% 
  ...
  scale_size_continuous(guide = "none", limits = c(0, 2.2810334)) + 
  labs(title = "VI.",
       fill = "DCRA Date of Death Data Availability") + 
  theme_void() +
  annotate(
     geom = "text", x = -70, y = 37, 
     label = "DC", size = 3
...
plot7_wo_title <- joined_agg %>% 
  ...
  scale_size_continuous(guide = "none", limits = c(0, 2.2810334)) + 
  labs(title = "VII.",
       fill = "DCRA Time of Death Data Availability") + 
  theme_void() +
  annotate(
     geom = "text", x = -70, y = 37, 
     label = "DC", size = 3
...
plot8_wo_title <- joined_agg %>% 
  ...
  scale_size_continuous(guide = "none", limits = c(0, 2.2810334)) + 
  labs(title = "VIII.",
       fill = "DCRA Location of Death Data Availability") + 
  theme_void() +
  annotate(
     geom = "text", x = -70, y = 37, 
     label = "DC", size = 3
...
plot9_wo_title <- joined_agg %>% 
  ...
  scale_size_continuous(guide = "none", limits = c(0, 2.2810334)) + 
  labs(title = "IX.",
       fill = "DCRA Facility Data Availability") + 
  theme_void() +
  annotate(
     geom = "text", x = -70, y = 37, 
     label = "DC", size = 3
...
plot10_wo_title <- joined_agg %>% 
  ...
  scale_size_continuous(guide = "none", limits = c(0, 2.2810334)) + 
  labs(title = "X.",
       fill = "DCRA Cause of Death Data Availability") + 
  theme_void() +
  annotate(
     geom = "text", x = -70, y = 37, 
     label = "DC", size = 3
...
plot1 <- plot1_wo_title +
  labs(title = "39% (n = 21) of systems contain DCRA name data in press releases") 

#DCRA Field - Date of Birth 
plot2 <- plot2_wo_title + 
  labs(title = "37% (n = 20) of systems contain DCRA date of birth data in press releases") 

#DCRA Field - Gender 
plot3 <- plot3_wo_title + 
  labs(title = "37% (n = 20) of systems contain DCRA gender data in press releases") 

#DCRA Field - Race
plot4 <- plot4_wo_title + 
  labs(title = "57% (n = 31) of systems contain DCRA race data in press releases") 

#DCRA Field - Ethnicity 
plot5 <- plot5_wo_title + 
  labs(title = "22% (n = 12) of systems contain DCRA ethnicity data in press releases") 

#DCRA Field - Date of Death 
plot6 <- plot6_wo_title + 
  labs(title = "72% (n = 39) of systems contain DCRA date of death data in press releases") 

#DCRA Field - Time of Death 
plot7 <- plot7_wo_title +
  labs(title = "13% (n = 7) of systems contain DCRA time of death data in press releases") 

#DCRA Field - Location of Death
plot8 <- plot8_wo_title + 
  labs(title = "54% (n = 29) of systems contain DCRA location of death data in press releases")

#DCRA Field - Facility 
plot9 <- plot9_wo_title + 
  labs(title = "30% (n = 16) of systems contain DCRA facility data in press releases") 

#DCRA Field - Cause of Death 
plot10 <- plot10_wo_title + 
  labs(title = "33% (n = 18) of systems contain DCRA cause of death data in press releases") 
...
```{r}
path_wo_title <- here("working_doc_files", "dashboard_visualizations", "fieldlevel_completeness_chloropleth_wo_title.png")
path_w_title <- here("working_doc_files", "dashboard_visualizations", "fieldlevel_completeness_chloropleth_w_title.png") 
...
```{r}
path_wo_title <- here("working_doc_files", "dashboard_visualizations", "fieldlevel_completeness_bar_wo_title.png")
path_w_title <- here("working_doc_files", "dashboard_visualizations", "fieldlevel_completeness_bar_w_title.png") 
