...
# Create new variables that indicate if the data is present or not
...
# Create variable that calculates the percentage of fields reported by system
...
```
# Create final tibble with percentages

```{r}
simple_comp = subset(comp_data, select = c(c_system_abbr, cum_sum_dplyr, n, total_fields))
