...
bja_dataset_sub %>% 
  filter(system %in% missing_prison_systems)

#setdiff(prison_systems, bja_dataset_sub$system) 
#setdiff(bja_dataset_sub$system, prison_systems) 
#setdiff(prison_systems, tcp_data$system)
#setdiff(tcp_data$system, prison_systems)
```
